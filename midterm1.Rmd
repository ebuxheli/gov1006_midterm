...
```{r table1_prep, include=FALSE, cache = TRUE, results='asis'}
# This code block is dedicated to the preparation of the data for the replication of the data in Table 1. This makes it possible to avoid the junk output in the PDF, but still allows me to use it. By avoiding the junk output by putting it in this block, I can use the rstanarm package to perform regressions. 
...
# Performing the linear regression for the filtered data
t1_anxiety <- lm(data = anx_data, SCDBradSelfReport1_mean ~ anxcond)
t1_imm     <- lm(data = anx_data, immigration ~ SCDBradSelfReport1_mean + storycond + anxcond) 
...
#           header = FALSE, style = "apsr", font.size = "small",
