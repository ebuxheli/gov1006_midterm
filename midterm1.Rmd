...
pp_check(mod, "stat_2d") +
  labs(title = "Immigration Statistics: Actual vs. Bayesian Linear Model Predictions",
       x = "Mean",
       y = "Standard Deviation")
```

### Model Fit Comparison: Should ideology be considered?
```{r ex2}
